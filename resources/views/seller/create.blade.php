...
@section('content')
    ...
    <div class="container mx-auto  py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-100">Создать продавца</h1>
        ...
        <div class="card max-w-2xl">
            <form method="POST" action="{{ route('seller.store') }}" class="auth-form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        <option value="ozon" {{ old('platform') == 'ozon' ? 'selected' : '' }}>Ozon</option>
                        <option value="wildberries" {{ old('platform') == 'wildberries' ? 'selected' : '' }}>Wildberries</option>
                        <option value="yandex_market" {{ old('platform') == 'yandex_market' ? 'selected' : '' }}>Яндекс.Маркет</option>
                        <option value="avito" {{ old('platform') == 'avito' ? 'selected' : '' }}>Avito</option>
